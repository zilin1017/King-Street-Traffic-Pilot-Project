#### Preamble ####
# Purpose: Models the log(the traffic volume)[take the logarithm of volume] based on classification, intersection of road and the period of time using  linear regression model.
# Author: Irene Liu
